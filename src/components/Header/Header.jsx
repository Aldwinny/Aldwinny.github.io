...
function Header() {
  return (
    <header className='mx-16 my-40'>
        ...
        <h2 className='text-xl mb-5 text-themic-txt-secondary w-3/4'>I'm a 21 yr old Filipino presently taking Bachelor of Science in Information Technology at Technological Institute of the Philippines. I enjoy programming because it challenges my mind by building software and solving problems.</h2>
